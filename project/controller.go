...
func (c *Controller) PostCreate() mvc.Result {
	...
	if err := c.Ctx.ReadJSON(&project); err != nil {
		return Response(4000, err.Error(), map[string]string{})
	}
	result, code, err := c.Service.Create(project)
	if err != nil {
		return Response(code, err.Error(), map[string]string{})
	}
	return Response(code, "Create Success", result)
}
...
func (c *Controller) PutUpdate() mvc.Result {
	...
	return Response(code, "Update Success", updateProject)
}
...
func (c *Controller) GetBy(id uint16) mvc.Result {
	...
	return Response(code, "Project Found", selectProject)
}
...
func (c *Controller) Get() mvc.Result {
	...
	return Response(2000, "", map[string]string{})
}

// TODO: Delete interface complete
func (c *Controller) DeleteBy(pid uint16) mvc.Result {
	return Response(2000, "nil", map[string]string{})
}
